                    ...
                    <div class="user-pro-body">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu animated flipInY">
                                ...
                                <!-- text-->
                                <a href="javascript:void(0)" class="dropdown-item"><i class="ti-wallet"></i> Saldo Saya</a>
                                <!-- text-->
                                <a href="javascript:void(0)" class="dropdown-item"><i class="ti-email"></i> Pesan</a>
                                <!-- text-->
                    ...
                    <ul id="sidebarnav">
                        <li>
                            <div class="hide-menu text-center">
                                ...
                                <small>Pendapatan - 2021</small>
                                <h4>Rp.2.000.000</h4>
                            </div>
                        </li>
                        <li class="nav-small-cap">--- PERSONAL</li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="icon-speedometer"></i><span class="hide-menu">Dashboard <span class="badge badge-pill badge-cyan ml-auto">7</span></span></a>
